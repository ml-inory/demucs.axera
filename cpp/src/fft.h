...
namespace Fft {
	...
	vec_complex ifft(const vec_complex &signal, size_t vec_begin = 0, size_t vec_size = 0, bool in_place = false);
	...
	mat_complex stft_ifft(vec_complex &vec, size_t window_size, size_t window_step, bool in_place = false);
